...
import org.thosp.HackCBS.service.ReconciliationDbService;
import org.thosp.HackCBS.utils.ApiKeys;
...
public class LocationsActivity extends BaseActivity {
    ...
    private void setupRecyclerView() {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(org.thosp.HackCBS.LocationsActivity.this));
    ...
    private void deleteLocation(int position) {
        CurrentWeatherDbHelper currentWeatherDbHelper = CurrentWeatherDbHelper.getInstance(org.thosp.HackCBS.LocationsActivity.this);
        WeatherForecastDbHelper weatherForecastDbHelper = WeatherForecastDbHelper.getInstance(org.thosp.HackCBS.LocationsActivity.this);
    ...
    private class LocationsAdapter extends RecyclerView.Adapter<LocationHolder> {
        ...
        public LocationHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(org.thosp.HackCBS.LocationsActivity.this);
